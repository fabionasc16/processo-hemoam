...
<div class="form-row">
    ...
    <input name="campo2" type="hidden" value="{{ $cpf }}" readonly />
    ...
    <div class="form-group col-sm-6 col-md-6 col-lg-6">
        ...
        <input type="date" min="01" name="nascimento" id="nascimento" class="form-control"
            value="{{ old('nascimento') }}" maxlength="100" required />
    </div>
    ...
    <div class="form-group col-sm-6 col-md-6 col-lg-6">
        ...
        <input name="local_nascimento" id="local_nascimento" class="form-control" value="{{ old('local_nascimento') }}"
    ...
    <div class="form-group col-sm-6 col-md-6 col-lg-6">
        ...
        <select class="form-control" name="estado_civil" id="estado_civil" onchange="campoEstadoCivil(this.value)"
            required>
            <option value="" selected>-- Selecione --</option>
    ...
    <div class="form-group col-sm-6 col-md-6 col-lg-6">
        ...
        <input name="telefone" id="telefone" class="form-control telefone" value="{{ old('telefone') }}" tabindex="18"
            maxlength="50" minlength="9" required />
    </div>
    ...
    <div class="form-group col-sm-2 col-md-2 col-lg-2">
        ...
        <input name="cidade" class="form-control" id="cidade" value="{{ old('cidade') }}" maxlength="255" required />
    </div>

    <div class="form-group col-sm-2 col-md-2 col-lg-2">
        <label>UF<span class="obrigatorio">*</span></label>
        <input name="uf" class="form-control" id="uf" value="{{ old('uf') }}" maxlength="2" required />
    </div>
